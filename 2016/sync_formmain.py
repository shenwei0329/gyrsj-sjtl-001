...
# 获取业务线2的formmain表名列表
formmain_rec = utils.get_formmain(cur_mysql,3)
# 同步每个formmain表
for f in formmain_rec:
	utils.sync_formmain(cur_oracle,cur_mysql,f)

# 获取业务线2的formmain表名列表
formmain_rec = utils.get_formmain(cur_mysql,4)
# 同步每个formmain表
for f in formmain_rec:
	utils.sync_formmain(cur_oracle,cur_mysql,f)

# 获取业务线2的formmain表名列表
formmain_rec = utils.get_formmain(cur_mysql,5)
# 同步每个formmain表
for f in formmain_rec:
	utils.sync_formmain(cur_oracle,cur_mysql,f)

# 获取业务线2的formmain表名列表
formmain_rec = utils.get_formmain(cur_mysql,6)
# 同步每个formmain表
for f in formmain_rec:
	utils.sync_formmain(cur_oracle,cur_mysql,f)

# 获取业务线2的formmain表名列表
formmain_rec = utils.get_formmain(cur_mysql,7)
# 同步每个formmain表
for f in formmain_rec:
	utils.sync_formmain(cur_oracle,cur_mysql,f)
